      ...
      <section className='relative py-16 px-4 sm:px-6 lg:px-8 bg-white border-b border-gray-100'>
        <Container>
          <div className='max-w-4xl mx-auto text-center'>
            <div className='inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-cyan-500 to-indigo-500 rounded-2xl mb-8 shadow-lg'>
            ...
            <p className='text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed'>
              We're here to help with expert support available 24/7 for all your needs
            </p>
            <div className='flex flex-wrap gap-3 justify-center'>
              ...
              <span className='px-4 py-2 bg-orange-100 text-orange-700 rounded-full text-sm font-medium flex items-center'>
