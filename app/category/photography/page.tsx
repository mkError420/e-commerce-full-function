...
const PhotographyPage = () => {
  ...
  const photographyCategories = [
    { id: 'cameras', name: 'Cameras', icon: Camera, count: 18 },
    { id: 'accessories', name: 'Accessories', icon: Image, count: 11 }
  ]

  // Sample photography products
  ...
  const filteredAndSortedProducts = useMemo(() => {
    let filtered = photographyProducts.filter(product => {
      ...
      <Container className='py-8'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-lg text-gray-600 max-w-3xl'>
            Capture life's moments with our professional photography equipment. From cameras to accessories, find everything you need for perfect shots.
          </p>
        </div>
        ...
        <div className='mb-8'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            {photographyCategories.map((subcat) => {
              ...
              return (
                <div key={subcat.id} className='bg-white rounded-lg p-4 text-center shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-gray-100'>
                  <div className='inline-flex items-center justify-center w-12 h-12 rounded-lg bg-teal-100 text-teal-600 mb-3 mx-auto'>
